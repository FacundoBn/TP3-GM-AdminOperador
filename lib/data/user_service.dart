...
class UserService{
  ...
  FutureOr<List<UserModel>> fetchClientsByRole(String role) async{
     try{
      final query = await _firestore
                      .collection('users')
                      .where('roleIds',arrayContains: role)
                      .get();
      debugPrint('user_service: fetchByROl: ${query.docs.toList.toString()}');
